...
% save runtimes
tab = table(runtime, 'VariableNames', "hyperparam_tuning_first_day", 'RowNames', "tree");
...
save([box_dir filesep 'training' filesep 'hyperparameter_tuning_first_day_roi_tree.mat'],...
    'results', 'best_params');
