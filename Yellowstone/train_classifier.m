...
disp('training RUSBoost ensemble');
rusBoost = trainClassifier([data.xpol_processed; data.labels].');
save([box_dir filesep 'rusBoost'], 'rusBoost');

%% Function for training RUSBoost ensemble
% This function was autogenerated by the Classification Learner app.
% The classification learner performed a hyperparameter search, the results of
% which are reflected in this function.
...
% Auto-generated by MATLAB on 17-Dec-2020 17:09:43
...
classificationEnsemble = fitcensemble(...
    ...
    response, ...
    'Method', 'RUSBoost', ...
    'NumLearningCycles', 474, ...
    'Learners', template, ...
    'LearnRate', 0.9910127021007056, ...
    'Cost', [0 3; 7 0], ...
    'ClassNames', [0; 1]);
