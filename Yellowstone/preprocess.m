function preprocessed_data = preprocess(data, surface_idx, surface_pad, column_height)
%% Data preprocessing
...
preprocessed_data = normalize_surface_height(data, surface_idx, surface_pad);
