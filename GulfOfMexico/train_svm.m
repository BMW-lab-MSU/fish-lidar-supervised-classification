...
load([box_dir filesep 'training' filesep 'hyperparameter_tuning_roi_svm.mat'], 'best_params')
params = best_params

%% Train SVM
model = train_base(@svm, params, undersampling_ratio, training_data, ...
    training_labels, training_roi_indicator);

% save the model and results
model_dir = [box_dir filesep 'training' filesep 'models'];
mkdir(model_dir);
save([model_dir filesep 'svm.mat'], 'model');
