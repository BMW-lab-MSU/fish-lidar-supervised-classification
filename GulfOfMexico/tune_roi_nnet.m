...
load([box_dir filesep 'training' filesep 'hyperparameter_tuning_roi_nnet.mat'])
params = best_params
clear best_params
...
% save runtimes
tab = table(runtime, 'VariableNames', "roi_tuning", 'RowNames', "nnet");
...
save([box_dir filesep 'training' filesep 'roi_label_tuning_nnet.mat'], 'result')
