...
load([box_dir filesep 'training' filesep 'hyperparameter_tuning_roi_nnet.mat'], 'best_params')
params = best_params

%% Train neural network
model = train_base(@nnet, params, undersampling_ratio, training_data, ...
    training_labels, training_roi_indicator);

% save the model and results
model_dir = [box_dir filesep 'training' filesep 'models'];
mkdir(model_dir);
save([model_dir filesep 'nnet.mat'], 'model');
