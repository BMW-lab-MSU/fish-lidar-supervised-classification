...
load([box_dir filesep 'training' filesep 'hyperparameter_tuning_first_day_roi_tree.mat'])
params = best_params
clear best_params
...
% save runtimes
tab = table(runtime, 'VariableNames', "roi_tuning_first_day", 'RowNames', "tree");
...
save([box_dir filesep 'training' filesep 'roi_label_tuning_first_day_tree.mat'], 'result')
