function [labels] = create_labels(data_dir, label_dir, data_file_name)
...
jellies_matrix_path =  (string(label_dir) + string(jellies_label_file_name));
schools_matrix_path = (string(label_dir) + string(schools_label_file_name));
layers_matrix_path = (string(label_dir) + string(layers_label_file_name));
singles_matrix_path = (string(label_dir) + string(singles_label_file_name));
